...
export const sendEmail = async(options) => {
    ...
    try {
        ...
        throw new ApiError(500, "Error occurred while sending email", error.message);
    }
}
...
body:{
    name: username,
    intro: 'Welcome to Manual OTP Auth! We\'re very excited to have you on board.',
    action:{
        instructions: 'To get started with your account, please use the following OTP for email verification:',
        button:{
            color: '#22BC66',
...
export const passwordResetEmailTemplate = (username, resetPasswordOtp) => ({
